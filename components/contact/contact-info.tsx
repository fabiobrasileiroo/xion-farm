      ...
      <CardContent className="space-y-6">
        <div className="flex items-start gap-4">
          ...
          <div>
            ...
            <p className="text-muted-foreground">info@xionfarm.com</p>
            <p className="text-muted-foreground">support@xionfarm.com</p>
          </div>
        </div>
        ...
        <div className="pt-4">
          <div className="bg-muted p-4 rounded-lg">
            <h3 className="font-medium mb-2">Connect with us on social media</h3>
